...
A list of ASNs known to belong to cloud, managed hosting, and colo facilities.

> [!NOTE]
> This is a fork of an open source project, to be used in Snowplow services.
> Below are the notes from the original creator, Brian Hamachek (brian@brianhama.com).
